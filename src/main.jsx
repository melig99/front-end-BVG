...
import { FormularioContrasenha } from './componentes/configuracion/FormularioContrasenha'
import { FormularioPerfil } from './componentes/configuracion/FormularioPerfil'
    ...
    <Routes>
      <Route path='/' element={<App />}>
        ...
        <Route path='home' element={<Home />} >
          <Route path='restablecerContrasenha' element={<FormularioContrasenha />} />
          <Route path='vistaPerfil' element={<FormularioPerfil />} />
