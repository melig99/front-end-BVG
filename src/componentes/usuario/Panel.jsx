...
export const Panel = () => {
    ...
    const eliminarFila = async (id) => {
        let temp = await eliminarRegistro('api/usuario', id)
        console.log(temp)
        if (temp.cod == 0) {
    ...
    useEffect(() => {
        obtenerPanel("api/usuario", setDatos)
    }, []);
        ...
        <>
                        ...
                        <Container fluid={true} id="acciones">
                            ...
                            <Row>
                                ...
                                <Col sm={8} className="d-flex flex-row-reverse">
                                    <Button variant="primary" onClick={() => { setSelecionado(""); (setEstadoForm(!estadoForm)) }}>Nuevo Usuario</Button>
                                </Col>
                            </Row>
                            <br />
                        </Container>
            ...
            <Modal show={estadoForm} size="lg" animation={false} onHide={() => setEstadoForm(!estadoForm)}>
                <Modal.Header closeButton>
                    <Modal.Title>Datos Usuarios</Modal.Title>
                </Modal.Header>
                <Modal.Body>
